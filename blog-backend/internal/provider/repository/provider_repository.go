...
func (r *Repository) ReserveProviderID(ctx context.Context) (int64, error) {
	var id int64
...
func (r *Repository) SetDefaultProvider(ctx context.Context, id int64, purpose string) error {
