...
type CommunityRepository interface {
	CreateComment(context.Context, *communitydomain.Comment) error
	GetVisibleComments(context.Context, int64) ([]*communitydomain.Comment, error)
	GetAllComments(context.Context, int64) ([]*communitydomain.Comment, error)
	ListCommentsForAdmin(context.Context, string, bool, int, int) ([]*communitydomain.Comment, int, error)
	...
	SetLike(context.Context, int64, string, bool) (*communitydomain.State, error)
	CommunityState(context.Context, int64, string, string) (*communitydomain.State, error)
	ListNotifications(context.Context, int64, int, int) ([]*communitydomain.Notification, int, error)
...
func (s *CommunityService) CreateComment(ctx context.Context, postID int64, parentID *int64, actor Actor, suppliedAuthor, content string) (*communitydomain.Comment, error) {
	...
	comment := &communitydomain.Comment{
...
func (s *CommunityService) GetComments(ctx context.Context, postID int64) ([]*communitydomain.Comment, error) {
	return s.repo.GetVisibleComments(ctx, postID)
}

func (s *CommunityService) GetAllComments(ctx context.Context, postID int64) ([]*communitydomain.Comment, error) {
	return s.repo.GetAllComments(ctx, postID)
}

func (s *CommunityService) ListAdminComments(ctx context.Context, status string, reported bool, page, pageSize int) ([]*communitydomain.Comment, int, error) {
...
func (s *CommunityService) SetLike(ctx context.Context, postID int64, actor Actor, liked bool) (*communitydomain.State, error) {
	return s.repo.SetLike(ctx, postID, actor.Key, liked)
}

func (s *CommunityService) State(ctx context.Context, postID int64, actor Actor) (*communitydomain.State, error) {
	return s.repo.CommunityState(ctx, postID, actor.Key, "")
}

func (s *CommunityService) ListNotifications(ctx context.Context, principalID int64, page, pageSize int) ([]*communitydomain.Notification, int, error) {
	if page < 1 {
		page = 1
	}
	if pageSize < 1 || pageSize > 100 {
