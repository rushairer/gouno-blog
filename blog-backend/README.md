...
blog is a web project generated by gouno.
...
```bash
git clone github.com/rushairer/blog-backend
cd blog
```
...
```bash
curl https://blog.dev.local/test/alive
# Expected output: pong
```

## Contribution

Contributions to blog are welcome through the following methods:
