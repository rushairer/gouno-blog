...
function Table({ density = "default", className, ...props }) {
    return (_jsx("div", { "data-slot": "table-container", "data-density": density, className: "relative w-full overflow-x-auto", children: _jsx("table", { "data-slot": "table", className: cn("w-full caption-bottom text-sm", className), ...props }) }));
}
