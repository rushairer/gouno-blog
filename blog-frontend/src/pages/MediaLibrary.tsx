...
interface MediaCandidate { id: number; post_id: number; source_run_id: number; headline: string; brief: string; platform?: string; provider: string; model: string; input_tokens: number; output_tokens: number; generation_status: string; safety_status: string; copyright_status: string; alt_text: string; review_note?: string; created_at: string }
