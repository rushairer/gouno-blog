...
describe('PostEditor', () => {
  ...
  it('loads draft posts via getAdminPost and renders fields', async () => {
    ...
    const getAdminPostSpy = vi.spyOn(postsApi, 'getAdminPost').mockResolvedValue(mockDraft);
    ...
    expect(await screen.findByDisplayValue('每日AI资讯：2026年8月21日')).toBeInTheDocument();
    ...
    expect(screen.getByLabelText('文章正文 Markdown')).toHaveValue('AI 运营生成的正文内容。');
  });
});
