...
function alertPresentation(alert: Summary['ai_alerts'][number]) {
  ...
  const destination = workflow
    ? `/admin/ai-ops?tab=records${workflowID ? `&workflow=${workflowID}` : ''}`
