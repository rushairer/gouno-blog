...
export type InputProps = Omit<React.InputHTMLAttributes<HTMLInputElement>, 'size'> & ControlProps;
export type SelectProps = Omit<React.SelectHTMLAttributes<HTMLSelectElement>, 'size'> & ControlProps;
