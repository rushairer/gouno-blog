...
export interface WorkflowRunDetailProps {
  ...
  onResolveInteraction: (task: WorkflowInteractionTask, response: unknown) => Promise<void>;
            ...
            actions={
              <div className="row-actions">
                ...
                {['succeeded', 'failed', 'cancelled'].includes(selected.run.status) ? (
                  <Button variant="secondary" type="button" disabled={deleting} onClick={() => void onDeleteRun()}>
