    ...
    <>
      ...
      {!editingAgent && !editingSkill ? (
        <div data-pattern="settings-composition" className="contents">
          {!editingAgent && advancedSection === "tools" ? (
            <div className="flex flex-col gap-5">
              ...
              {tools.length === 0 ? (
                <Card padding="base">
                  <Empty
                    description={locale === "zh" ? "暂无 Tool" : "No Tools"}
                  />
                </Card>
              ) : (
          ...
          {!editingAgent && !editingSkill && advancedSection === "skills" ? (
            <div className="flex flex-col gap-5">
              <input
                      ...
                      <div className="flex h-full flex-col gap-4">
                        <div className="min-w-0">
                          <div className="flex flex-wrap items-center gap-2">
                            ...
                            <Tag
                              color={skill.system_key ? "primary" : "default"}
                            >
                              {skill.system_key
                                ? locale === "zh"
                                  ? "系统 Skill"
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      ...
                      <label className="flex flex-col gap-2">
                        ...
                        <Select
                          value={String(
                            providers.find((item) => item.is_default_image)
                              ?.id || "",
                          )}
                          onChange={(value) => {
                            const id = value ? Number(value) : 0;
          ...
          {!editingAgent && advancedSection === "knowledge" ? (
            <SudoGate
              title="知识库与向量模型保护"
                          ...
                          >
                            <div className="min-w-0">
                              <div className="flex flex-wrap items-center gap-2">
                                ...
                                <Tag
                                  color={
                                    profile.enabled ? "success" : "default"
                                  }
                                >
                                  {profile.enabled
                                    ? labels.active
