...
describe("applySiteMetadata", () => {
  beforeEach(() => {
    document.head.innerHTML =
      '<link id="site-favicon" rel="icon" href="/favicon.svg"><meta name="theme-color" content="#24513f"><meta name="description" content="default">';
  ...
  it("uses configured browser identity settings", () => {
    ...
    ).toHaveAttribute("content", "A configured description.");
