...
for (const fileName of aiHandoffCollections) {
  ...
  forbidText(
    buttonSource,
    "icon={<Bot />}",
    `${fileName}: Bot is reserved for Agent/AI entity semantics, not generic AI handoff actions`,
  );
}
